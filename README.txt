...
The final propagator is also printed on file in the SpProp/ folder. The hole part is stored into the "spprop_backward_sc0.dat" and the particle part is stored into the "spprop_forward_sc0.dat". The first element of both files is the number of s.p. energies.
